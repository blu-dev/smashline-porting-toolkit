...
pub fn install () { smashline :: Agent :: new ("mario") . game_acmd ("game_attack11" , mario_attack_11_game) . game_acmd ("game_attack12" , mario_attack_12_game) . game_acmd ("game_attack13" , mario_attack_13_game) . expression_acmd ("expression_attack13" , mario_attack_13_expression) . game_acmd ("game_attackdash" , mario_attack_dash_game) . install () ; }