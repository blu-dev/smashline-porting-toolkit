...
pub fn install () { smashline :: Agent :: new ("mario") . game_acmd ("game_catch" , mario_grab) . game_acmd ("game_catchdash" , mario_dashgrab) . game_acmd ("game_catchturn" , mario_pivotgrab) . game_acmd ("game_throwf" , mario_throw_f_game) . game_acmd ("game_throwb" , mario_throw_b_game) . game_acmd ("game_throwhi" , mario_throw_hi_game) . game_acmd ("game_throwlw" , mario_throw_lw_game) . install () ; }