...
pub fn install () { smashline :: Agent :: new ("mario_pumpwater") . game_acmd ("game_regular" , game_regular) . effect_acmd ("effect_regular" , effect_regular) . effect_acmd ("effect_hit" , effect_hit) . effect_acmd ("effect_clash" , effect_clash) . sound_acmd ("sound_regular" , sound_regular) . install () ; smashline :: Agent :: new ("mario_pump") . effect_acmd ("effect_light" , effect_light) . install () ; smashline :: Agent :: new ("mario_fireball") . game_acmd ("game_regular" , mario_fireball_regular_game) . install () ; smashline :: Agent :: new ("mario") . sound_acmd ("sound_damageflyhi" , damageflyhi_sound) . sound_acmd ("sound_damageflylw" , damageflylw_sound) . sound_acmd ("sound_damageflyn" , damageflyn_sound) . sound_acmd ("sound_damageflyroll" , damageflyroll_sound) . sound_acmd ("sound_damageflytop" , damageflytop_sound) . game_acmd ("game_appealhir" , mario_utauntr) . game_acmd ("game_appealhil" , mario_utauntl) . game_acmd ("game_dash" , dash_game) . sound_acmd ("sound_dash" , dash_sound) . game_acmd ("game_turndash" , turn_dash_game) . game_acmd ("game_escapeair" , escape_air_game) . game_acmd ("game_escapeairslide" , escape_air_slide_game) . game_acmd ("game_appealsl" , game_appealsl) . game_acmd ("game_appealsr" , game_appealsr) . expression_acmd ("expression_appealsl" , expression_appeals) . expression_acmd ("expression_appealsr" , expression_appeals) . install () ; }