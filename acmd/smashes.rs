...
pub fn install () { smashline :: Agent :: new ("mario") . game_acmd ("game_attacks4hi" , mario_attack_s4_hi_game) . game_acmd ("game_attacks4" , mario_attack_s4_s_game) . game_acmd ("game_attacks4lw" , mario_attack_s4_lw_game) . game_acmd ("game_attackhi4" , mario_attack_hi4_game) . effect_acmd ("effect_attackhi4" , mario_attack_hi4_effect) . game_acmd ("game_attacklw4" , mario_attack_lw4_game) . install () ; }